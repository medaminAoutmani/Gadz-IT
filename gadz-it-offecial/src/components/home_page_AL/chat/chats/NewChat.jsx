...
const NewChat = ({ setNewChat }) => {
  ...
  return (
    <Box className="divflex-new-chat-auto2" sx={{ transition: 'width 0.5s' }}>
      ...
      >
        <Box className='header-box-new-chat-contacts' >
          <Stack
          ...
          >
            ...
            <Typography variant="h6" color={'white'}>New chat</Typography>
          </Stack>
          <Grid
            container
            direction="row"
            ...
            alignItems="center"
            sx={{ width: "minWidth", marginTop: '6px' }}
            className='search-new-chat-grid'
          >
            <FormControl className='form-new-chat-control' >
              <CssTextField
                id="standard-basic"
        ...
        <Grid item xs={12} md={12} sx={{ width: "100%" }} className='contacts-grid-new-chat'>
          <div>
