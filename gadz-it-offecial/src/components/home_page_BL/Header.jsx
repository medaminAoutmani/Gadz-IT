...
import logo from '../../public/logo-gadz-offeciel-1.svg'
...
const HeaderBL = ({ onToggleWhiteMode, onToggleSideBarActive, isWhiteMode }) => {
  ...
  return (
    <div className="w-full h-[50px] md:h-[60px] lg:h-[60px]  flex flex-col justify-start items-center ">
      <div className={`h-[60px] md:h-[70px] w-full flex self-stretch overflow-hidden flex-row items-center justify-end relative ${isWhiteMode ? 'shadow ' : 'border-b-[#312e37] border-b-[0.8px]'} `}>
        <button
          className={` relative w-[70px] h-[40px] flex items-center justify-end pointer border-0 ${isWhiteMode ? '' : 'bg-transparent'} px-2 my-[15px] mx-0 transition-all duration-500 ease-in-out hover:scale-110 `}
        >
          <img
            src={logo}
            alt='Gadz IT'
